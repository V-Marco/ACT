...
def save_prediction_plots(target_V: torch.Tensor, amp: list, simulation_constants: object, predicted_params_values: torch.Tensor, output_folder: str) -> None:

    _, ax = plt.subplots(1, 1, figsize = (10, 10))
    optim = ACTOptimizer(simulation_constants = simulation_constants)
    simulated_data = optim.simulate(amp, simulation_constants.params, predicted_params_values.detach().numpy())
