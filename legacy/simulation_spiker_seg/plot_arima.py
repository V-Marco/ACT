...
def plot_arima(cell_id, pq=10):
    ...
    ax.plot(times, pred.predicted_mean, label="ARIMA Fit", alpha=0.7)
...
if __name__ == "__main__":
    ...
    print(
        "pausing for PDB, run `plot_arima(100)` where 100 is the desired cell id, to plot an ARIMA fit for a trace"
    )
    import pdb
