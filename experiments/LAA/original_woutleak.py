...
for sim_idx, amp_value in enumerate(amps):
    sim_params = SimulationParameters(
        sim_name = "target",
        sim_idx = sim_idx,
        h_v_init=-70,
...
num_simulations = simulated_data.shape[0]
fig, ax = plt.subplots(1, num_simulations, figsize = (10, 12))
ax = ax.flatten()

for axid, amp in enumerate(amps):
